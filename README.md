...
* [Graphlient::Errors::FaradayServerError](lib/graphlient/errors/faraday_server_error.rb): This inherits from `ServerError` ☝️, we recommend using `ServerError` to catch these.
* [Graphlient::Errors::HttpServerError](lib/graphlient/errors/http_server_error.rb): This inherits from `ServerError` ☝️, we recommend using `ServerError` to catch these.
